...
//        let border: CALayer = CALayer()
//        border.backgroundColor = color.cgColor
//        border.frame = CGRect(x: 0, y: self.frame.size.height + 1  - borderWidth, width: self.frame.size.width, height: borderWidth)
//        self.layer.addSublayer(border)
//    }
    ...
    private struct AssociatedKey {
        ...
        static var badgeLabel           = "nb_UIButton.badgeLabel"
        static var badgeString          = "nb_UIButton.badgeString"
        static var badgeEdgeInsets      = "nb_UIButton.badgeEdgeInsets"
        static var badgeBackgroundColor = "nb_UIButton.badgeBackgroundColor"
        static var badgeTextColor       = "nb_UIButton.badgeTextColor"
