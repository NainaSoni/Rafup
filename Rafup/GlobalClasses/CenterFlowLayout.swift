...
public class CenterFlowLayout: UICollectionViewFlowLayout {

    public var activeDistance: CGFloat = 200
    public var zoomFactor: CGFloat = 0.3
    public var centerCellIndexPath: IndexPath = IndexPath.init(row: 0, section: 0)
    ...
    override public func prepare() {
        ...
        if #available(iOS 11.0, *) {
            ...
            verticalInsets = (collectionView.frame.height - collectionView.contentInset.top - collectionView.contentInset.bottom
            - itemSize.height) / 2
        }
        ...
        if #available(iOS 11.0, *) {
            ...
            // Fallback on earlier versions
            horizontalInsets = (collectionView.frame.height - collectionView.contentInset.top - collectionView.contentInset.bottom - itemSize.height) / 2
        }
    ...
    override public func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for attributes in rectAttributes where attributes.frame.intersects(visibleRect) {
            ...
            if distance.magnitude < activeDistance {
                ...
                centerCellIndexPath = attributes.indexPath
